...
public partial class TestClass // Partial class is required for source generator.
{
    ...
    [Link(Type = ChainType.Ordered, GenerateValue = true)] // Sorted link associated with name.
    public string Name { get; private set; } = string.Empty; // Generated property name: NameValue, chain name: NameChain

    [Link(Type = ChainType.Ordered, Accessibility = ValueLinkAccessibility.Public, GenerateValue = true)] // Sorted link associated with age.
