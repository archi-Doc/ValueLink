...
public class StackListChain<T> : IReadOnlyCollection<T>, ICollection
{
    ...
    public StackListChain(IGoshujin goshujin, ObjectToGoshujinDelegate objectToGoshujin, ObjectToLinkDelegate objectToLink)
    {
    ...
    /// </summary>
    /// <param name="obj">The non-null owned object to push onto the stack.</param>
    /// <returns><see langword="true"/> if the object was pushed; <see langword="false"/> if it was already linked.</returns>
