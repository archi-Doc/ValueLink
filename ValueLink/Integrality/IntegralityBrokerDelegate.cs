...
/// </summary>
/// <param name="request">Request bytes valid only until the returned task completes.</param>
...
public delegate Task<BytePool.RentedMemory> IntegralityBrokerDelegate(ReadOnlyMemory<byte> request, CancellationToken cancellationToken);
